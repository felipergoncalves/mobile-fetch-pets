...
import { fetchMyAdoptedPets, removePost } from '../../services/postService';
...
const AdoptedPets = () => {
    ...
    useEffect(() => {
        const loadPosts = async () => {
            setLoading(true);
            const result = await fetchMyAdoptedPets(user.id);
            if (result.success) {
                ...
                <View style={styles.container}>
                    <ScrollView style={{ flex: 1 }}>
                        <Image
                            ...
                            resizeMode="contain"
                            source={require('../../assets/images/adoptedPets.png')}
                        />
                        {loading ? (
